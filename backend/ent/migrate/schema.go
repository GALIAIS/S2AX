...
var (
	...
	AccountsColumns = []*schema.Column{
		...
		{Name: "rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(18,8)"}},
		{Name: "status", Type: field.TypeString, Size: 20, Default: "active"},
	...
	ChannelMonitorsColumns = []*schema.Column{
		...
		{Name: "updated_at", Type: field.TypeTime, SchemaType: map[string]string{"postgres": "timestamptz"}},
		{Name: "name", Type: field.TypeString, Size: 100},
		{Name: "provider", Type: field.TypeEnum, Enums: []string{"openai", "anthropic", "gemini", "grok", "antigravity", "kimi", "zhipu", "deepseek", "minimax", "devin"}},
	...
	GroupsColumns = []*schema.Column{
		...
		{Name: "peak_rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(18,8)"}},
		...
		{Name: "image_rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(18,8)"}},
		...
		{Name: "batch_image_discount_multiplier", Type: field.TypeFloat64, Default: 0.5, SchemaType: map[string]string{"postgres": "decimal(18,8)"}},
		{Name: "batch_image_hold_multiplier", Type: field.TypeFloat64, Default: 0.6, SchemaType: map[string]string{"postgres": "decimal(18,8)"}},
		{Name: "video_rate_independent", Type: field.TypeBool, Default: false},
		{Name: "video_rate_multiplier", Type: field.TypeFloat64, Default: 1, SchemaType: map[string]string{"postgres": "decimal(18,8)"}},
	...
	RedeemCodesColumns = []*schema.Column{
		...
		{Name: "currency_amount_units", Type: field.TypeInt64, Nullable: true},
		{Name: "currency_group_id", Type: field.TypeInt64, Nullable: true},
		{Name: "group_id", Type: field.TypeInt64, Nullable: true},
	...
	UsageLogsColumns = []*schema.Column{
		...
		{Name: "account_rate_multiplier", Type: field.TypeFloat64, Nullable: true, SchemaType: map[string]string{"postgres": "decimal(18,8)"}},
