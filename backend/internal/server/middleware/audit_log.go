...
var auditActionOverrides = map[string]string{
	...
	"POST /api/v1/admin/prompt-audit/events/:id/evidence/reveal":                 "admin.prompt_audit.event.evidence_reveal",
	"POST /api/v1/admin/security-audit/policies":                                 "admin.security_audit.policy.create",
	"POST /api/v1/admin/security-audit/policies/:key/versions/:version/validate": "admin.security_audit.policy.validate",
	"POST /api/v1/admin/security-audit/policies/:key/versions/:version/simulate": "admin.security_audit.policy.simulate",
	"POST /api/v1/admin/security-audit/policies/:key/versions/:version/shadow":   "admin.security_audit.policy.shadow",
	"POST /api/v1/admin/security-audit/policies/:key/versions/:version/activate": "admin.security_audit.policy.activate",
	"POST /api/v1/admin/security-audit/policies/:key/versions/:version/rollback": "admin.security_audit.policy.rollback",
	"POST /api/v1/admin/security-audit/decisions/:id/evidence/reveal":            "admin.security_audit.decision.evidence_reveal",
	"POST /api/v1/admin/security-audit/decisions/:id/open-case":                  "admin.security_audit.case.open",
	"POST /api/v1/admin/security-audit/decisions/:id/feedback":                   "admin.security_audit.feedback.create",
	"POST /api/v1/admin/security-audit/actions/:id/retry":                        "admin.security_audit.action.retry",
	"POST /api/v1/admin/security-audit/actions/:id/cancel":                       "admin.security_audit.action.cancel",
	"POST /api/v1/admin/security-audit/actions/:id/revert":                       "admin.security_audit.action.revert",
	"POST /api/v1/admin/security-audit/cases/:id/transition":                     "admin.security_audit.case.transition",
...
var auditBodyOmittedRoutes = map[string]struct{}{
	...
	"POST /api/v1/admin/prompt-audit/events/:id/evidence/reveal":                 {},
	"POST /api/v1/admin/security-audit/policies":                                 {},
	"POST /api/v1/admin/security-audit/policies/:key/versions/:version/validate": {},
	"POST /api/v1/admin/security-audit/policies/:key/versions/:version/simulate": {},
	"POST /api/v1/admin/security-audit/policies/:key/versions/:version/shadow":   {},
	"POST /api/v1/admin/security-audit/policies/:key/versions/:version/activate": {},
	"POST /api/v1/admin/security-audit/policies/:key/versions/:version/rollback": {},
	"POST /api/v1/admin/security-audit/decisions/:id/evidence/reveal":            {},
	"POST /api/v1/admin/security-audit/decisions/:id/open-case":                  {},
	"POST /api/v1/admin/security-audit/decisions/:id/feedback":                   {},
	"POST /api/v1/admin/security-audit/actions/:id/retry":                        {},
	"POST /api/v1/admin/security-audit/actions/:id/cancel":                       {},
	"POST /api/v1/admin/security-audit/actions/:id/revert":                       {},
	"POST /api/v1/admin/security-audit/cases/:id/transition":                     {},
