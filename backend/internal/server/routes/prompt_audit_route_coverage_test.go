...
func TestSecurityAuditHighImpactRoutesRequireStepUp(t *testing.T) {
	gin.SetMode(gin.TestMode)
	router := gin.New()
	handlers := &handler.Handlers{Admin: &handler.AdminHandlers{
		PromptAudit: securityaudit.NewPromptAdminHandler(nil),
	...
	registerPromptAuditRoutes(admin, handlers, stepUp)
	registerSecurityAuditRoutes(admin, handlers, stepUp)
	...
	routes := []struct {
		...
		{http.MethodPost, "/api/v1/admin/prompt-audit/jobs/1/retry"},
		{http.MethodPost, "/api/v1/admin/prompt-audit/jobs/1/quarantine"},
		{http.MethodPost, "/api/v1/admin/prompt-audit/jobs/1/discard"},
		{http.MethodPost, "/api/v1/admin/prompt-audit/events/1/evidence/reveal"},
		...
		{http.MethodPost, "/api/v1/admin/security-audit/policies/default/versions/1/activate"},
		{http.MethodPost, "/api/v1/admin/security-audit/policies/default/versions/1/rollback"},
		{http.MethodPost, "/api/v1/admin/security-audit/decisions/1/evidence/reveal"},
		{http.MethodPost, "/api/v1/admin/security-audit/actions/1/retry"},
		{http.MethodPost, "/api/v1/admin/security-audit/actions/1/cancel"},
		{http.MethodPost, "/api/v1/admin/security-audit/actions/1/revert"},
		{http.MethodPost, "/api/v1/admin/security-audit/cases/1/transition"},
		{http.MethodPost, "/api/v1/admin/security-audit/exceptions"},
		{http.MethodPost, "/api/v1/admin/security-audit/exceptions/1/expire"},
