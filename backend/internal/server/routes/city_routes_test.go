...
func TestRegisterUserRoutesIncludesCitySimulationKernel(t *testing.T) {
	...
	wanted := map[string]bool{
		...
		"GET /api/v1/city/worlds/:world_id/realtime/character/case-process":                               false,
		"GET /api/v1/city/worlds/:world_id/realtime/character/tasks":                                      false,
		"GET /api/v1/city/worlds/:world_id/realtime/character/navigation-plans":                           false,
		"GET /api/v1/city/worlds/:world_id/realtime/character/traffic-reservations":                       false,
		...
		"GET /api/v1/admin/city/agent-decision-queue":                                                     false,
		"GET /api/v1/admin/city/worlds/:world_id/agent-decision-queue/:request_code/dead-letter/events":   false,
		"POST /api/v1/admin/city/worlds/:world_id/pause":                                                  false,
		"POST /api/v1/admin/city/worlds/:world_id/resume":                                                 false,
		"GET /api/v1/admin/city/agent-model-profiles":                                                     false,
		"POST /api/v1/admin/city/agent-model-profiles":                                                    false,
		"PATCH /api/v1/admin/city/agent-model-profiles/:profile_code/head":                                false,
		"GET /api/v1/admin/city/worlds/:world_id/agent-model-bindings":                                    false,
		"POST /api/v1/admin/city/worlds/:world_id/agent-model-bindings":                                   false,
		"POST /api/v1/admin/city/worlds/:world_id/agent-decision-queue/:request_code/retry":               false,
		"POST /api/v1/admin/city/worlds/:world_id/agent-decision-queue/:request_code/dead-letter":         false,
		"POST /api/v1/admin/city/worlds/:world_id/agent-decision-queue/:request_code/dead-letter/release": false,
