...
func registerAccountAllocationRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	allocations := admin.Group("/account-allocations")
	{
		...
		allocations.GET("/usage-visibility-grants", h.Admin.AccountAllocation.ListUsageVisibilityGrants)
		allocations.POST("/usage-visibility-grants", h.Admin.AccountAllocation.CreateUsageVisibilityGrant)
		allocations.DELETE("/usage-visibility-grants/:id", h.Admin.AccountAllocation.DeleteUsageVisibilityGrant)
...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/ip-geolocation", h.Admin.Setting.GetIPGeolocationSettings)
		adminSettings.PUT("/ip-geolocation", h.Admin.Setting.UpdateIPGeolocationSettings)
