...
const (
	...
	RedeemTypeVirtualCurrency  = domain.RedeemTypeVirtualCurrency
...
const (
	...
	SettingKeyCityRealtimeAgentDecisionWorkerEnabled = "city_realtime_agent_decision_worker_enabled" // 是否允许后台执行已封存的 Agent 模型决策
