...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	sharedQuotaPoolRepository := repository.NewSharedQuotaPoolRepository(db)
	...
	sharedQuotaPoolService := service.ProvideSharedQuotaPoolService(sharedQuotaPoolRepository, accountRepository, openAIQuotaService)
	subscriptionService := service.ProvideSubscriptionService(groupRepository, userSubscriptionRepository, billingCacheService, client, configConfig, sharedQuotaPoolService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, passkeyHandler, handlerPaymentHandler, handlerVirtualCurrencyHandler, handlerVirtualCurrencyIntegrationHandler, paymentWebhookHandler, availableChannelHandler, modelPlazaHandler, asyncImageHandler, batchImageHandler, ipGeolocationHandler, handlerAccountAllocationHandler, idempotencyCoordinator, idempotencyCleanupService)
	...
	engine := server.ProvideRouter(configConfig, handlers, jwtAuthMiddleware, optionalJWTAuthMiddleware, adminAuthMiddleware, apiKeyAuthMiddleware, auditLogMiddleware, stepUpAuthMiddleware, apiKeyService, subscriptionService, opsService, settingService, compositeRouteResolver, invocationarchiveService, redisClient)
