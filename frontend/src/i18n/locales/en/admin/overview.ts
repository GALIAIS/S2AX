export default {
    ...
    users: {
      ...
      bulkSelected: '{count} users selected',
      bulkDelete: 'Delete users',
      bulkDisable: 'Disable users',
      bulkEnable: 'Enable users',
      bulkActionTitle: 'Confirm bulk action',
      bulkActionConfirm: 'Apply “{action}” to {count} selected users? Administrator accounts are excluded.',
      bulkSuccess: '“{action}” applied to {count} users',
      bulkPartial: 'Bulk action finished: {success} succeeded, {failed} failed',
      bulk: {
        enable: 'enable',
        disable: 'disable',
        delete: 'delete'
      ...
      selectVirtualCurrency: 'Select virtual currency',
      noVirtualCurrencies: 'No active virtual currencies',
      virtualCurrencyLoadFailed: 'Failed to load virtual currencies',
      virtualBalanceLoadFailed: 'Failed to load virtual currency balance',
      virtualAmountHint: 'Supports up to {scale} decimal places',
      virtualDepositReason: 'Administrator deposit',
      virtualWithdrawReason: 'Administrator refund',
    ...
    groups: {
      ...
      form: {
        ...
        rateMultiplierHint: '1.0 = standard rate, 0.5 = half price, 2.0 = double; non-zero minimum 0.000001',
        rpmLimit: 'Requests Per Minute (RPM)',
        rpmLimitPlaceholder: '0 = unlimited',
      ...
      rateMultiplierHint: 'Cost multiplier for this group (e.g., 1.5 = 150% of base cost); non-zero minimum 0.000001',
      ...
      bulkDeleteConfirm: 'Delete the {count} selected group(s)? This cannot be undone.',
      bulkDeleteSuccess: 'Deleted {count} group(s)',
      bulkDeletePartial: 'Deleted {success} group(s); {failed} failed',
