export default {
  sharedQuota: {
    ...
    officialHint: 'Estimates each member’s share of provider usage from costs since their subscription reset. Individual amounts act as relative shares in this mode; Analytics credits do not affect quota calculations.',
    officialAnalytics: 'Analytics credit calibration',
    analyticsCredits: 'credit',
    analyticsFallback: 'Provider usage allocation (estimate)',
