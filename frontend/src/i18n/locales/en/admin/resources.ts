export default {
    accountAllocations: {
      ...
      userHint: 'A policy does not change the user’s existing API keys or group authorization.',
      ...
      replace401: 'Replace authentication/unavailable accounts',
      replace401Hint: 'Release persistent authentication failures, disabled, expired, or unschedulable accounts, then refill to the desired count.',
      ...
      releaseConfirm: 'The account will return to the shared candidate pool. If auto replenish is on, the system may immediately assign a different idle account.',
