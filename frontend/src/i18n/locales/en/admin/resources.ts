export default {
    accountAllocations: {
      title: 'Account Allocation Control',
      description: 'Reserve upstream accounts from a group for specific users and replenish them from health state.',
      create: 'Create allocation policy',
      edit: 'Edit allocation policy',
      details: 'Manage allocations',
      detailsTitle: '{user} · {group}',
      rowActions: 'Account allocation actions for {email}',
      user: 'User',
      group: 'Group',
      selectUser: 'Select target user',
      selectGroup: 'Select source group',
      noUsers: 'No active users are available',
      userHint: 'A policy never changes authorization silently. It remains configured but pauses allocation when exclusive-group access or an active subscription is missing.',
      groupHint: 'Only healthy, idle accounts in this group that have no active lease can be selected.',
      desiredCount: 'Desired account count',
      desiredCountHint: 'With replenishment enabled, a shortage is filled from the idle pool. Extra manual assignments are never automatically revoked. Current per-policy limit: {max}.',
      autoReplenish: 'Auto replenish',
      autoReplenishHint: 'The background worker checks shortages on its own interval and never blocks a user request.',
      autoReplenishOn: 'Auto replenish',
      autoReplenishOff: 'Manual only',
      replace401: 'Replace 401 authentication failures',
      replace401Hint: 'Release accounts with a persisted 401 authentication failure. Deleted, unbound, disabled, expired, and otherwise hard-unavailable accounts are always released.',
      replace429: 'Replace rate-limited accounts',
      replace429Hint: 'Release accounts during a persisted 429 cooldown and attempt to refill from the idle pool.',
      capacity: 'Capacity',
      activeAssignments: 'Active assignments',
      shortage: 'Shortage',
      shortageCount: '{count} short',
      capacityMet: 'Met',
      lastReconciled: 'Last reconciliation',
      reconcileNow: 'Reconcile now',
      reconcileAll: 'Reconcile all',
      reconciled: 'Reconciled: assigned {assigned}, released {released}, shortage {shortage}',
      reconciledAll: 'Reconciled {processed} policies: assigned {assigned}, released {released}, total shortage {shortage}',
      reconcileFailed: 'Failed to reconcile account allocations',
      reconcileAllFailed: 'Failed to reconcile all account allocations',
      manualAssignment: 'Manual assignment',
      manualAssignmentHint: 'Choose from healthy idle accounts remaining in this group. An assigned account is exclusive globally.',
      selectCandidate: 'Select an idle account',
      noCandidates: 'No eligible idle accounts',
      policyDisabled: 'Policy is disabled',
      assignManually: 'Assign manually',
      assigned: 'Account assigned',
      assignFailed: 'Failed to assign account',
      assignments: 'Assignments',
      noAssignments: 'No assignments yet',
      account: 'Account',
      removedAccount: 'Deleted account',
      removedAccountHint: 'Only the allocation and audit history remain; the original account details were removed.',
      assignedAt: 'Assigned at',
      releaseReason: 'Release reason',
      assignmentActive: 'Active',
      assignmentReleased: 'Released',
      release: 'Release assignment',
      releaseConfirm: 'The account returns to the shared candidate pool. With auto replenish enabled, the system first tries another idle account and never assigns the just-released account back during this operation.',
      released: 'Assignment released',
      releaseFailed: 'Failed to release assignment',
      eventHistory: 'Event history',
      noEvents: 'No allocation events yet',
      systemActor: 'System',
      disable: 'Disable policy',
      enable: 'Enable policy',
      disableConfirm: 'Disabling immediately releases every active assignment in this policy and stops forced gateway routing and replenishment. Continue?',
      enableConfirm: 'Enabling enforces the leases again. If auto replenish is enabled, the system will fill to the desired count. Continue?',
      enabled: 'Policy enabled',
      disabled: 'Policy disabled',
      statusFailed: 'Failed to update policy status',
      deletePolicy: 'Delete allocation policy',
      deleteConfirm: 'Deleting releases every active assignment in this policy while retaining lease and audit history. You can then create a replacement policy for the same user and group. Continue?',
      deleted: 'Allocation policy deleted',
      deleteFailed: 'Failed to delete allocation policy',
      created: 'Allocation policy created',
      createFailed: 'Failed to create allocation policy',
      updated: 'Allocation policy updated',
      updateFailed: 'Failed to update allocation policy',
      loadFailed: 'Failed to load allocation policies',
      detailsLoadFailed: 'Failed to load allocation details',
      overviewLoadFailed: 'Failed to load allocation overview',
      referencesLoadFailed: 'Failed to load users or groups',
      formRequired: 'Select a user and a group.',
      accessBlockedHint: 'The control plane will not lease accounts from this group to the target user. Replenishment resumes automatically after the user, group, exclusive permission, or subscription becomes valid.',
      accessStatus: {
        ready: 'Access ready',
        user_unavailable: 'Target user unavailable',
        group_unavailable: 'Source group unavailable',
        group_access_required: 'Exclusive group access required',
        subscription_required: 'Active subscription required'
      },
      usageVisibility: {
        manage: 'Usage visibility',
        title: 'Account directory usage visibility',
        description: 'Exposes cached 5-hour and 7-day quota windows plus group-scoped window aggregates. This never probes the provider or grants group, API key, or scheduling access.',
        readOnlyNotice: 'Read-only detail grant',
        scope: 'Grant scope',
        exclusiveGroup: 'Exclusive-group users',
        exclusiveGroupHint: 'Current and future eligible users with group access or an active subscription can view cached quota and group-scoped window usage for accounts in this exclusive group.',
        userAccount: 'Specific user and account',
        userAccountHint: 'Only the selected user can view cached quota and group-scoped window usage for one account in the selected group.',
        selectAccount: 'Select account',
        selectGroupFirst: 'Select a group first',
        noExclusiveGroups: 'No active exclusive groups',
        noAccounts: 'No matching accounts in this group',
        activeGrants: 'Active grants',
        empty: 'No additional usage-detail grants are configured.',
        revokeHint: 'Revocation takes effect when the user next refreshes the directory. Detail access from an active dedicated assignment is unaffected.',
        target: 'Target',
        allEligibleUsers: 'All eligible users of this exclusive group',
        createdAt: 'Created',
        create: 'Create grant',
        revoke: 'Revoke grant',
        revokeConfirm: 'Revoke this usage-detail grant? The matching cached quota will disappear after the user next refreshes the account directory.',
        groupRequired: 'Select a target group.',
        userAccountRequired: 'Select a user and an account.',
        created: 'Usage-detail grant created',
        createFailed: 'Failed to create usage-detail grant',
        revoked: 'Usage-detail grant revoked',
        revokeFailed: 'Failed to revoke usage-detail grant',
        loadFailed: 'Failed to load usage-detail grants',
        accountsLoadFailed: 'Failed to load group accounts'
      },
      overview: {
        activePolicies: 'Active policies',
        allocatedCapacity: 'Assigned / desired',
        shortage: 'Account shortage',
        policyUnit: '{count} policies',
        blockedPolicies: 'Access-blocked policies'
      },
      filters: {
