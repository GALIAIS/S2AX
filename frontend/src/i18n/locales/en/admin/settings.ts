    ...
    settings: {
      ...
      features: {
        ...
        citySimulation: {
          ...
          pixelRenderer: 'Enable shared realtime pixel rendering',
          pixelRendererHint: 'Controls projection, visual-manifest, map Chunk, and delta APIs for shared realtime pixel worlds. Disabling it preserves worlds and timelines while closing this member-facing content plane.',
          visualPackPublish: 'Allow visual pack publication',
