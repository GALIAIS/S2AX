export default {
  ...
  accountAllocations: {
    ...
    description: 'Review public-group accounts and accounts in dedicated groups you can access.',
    readOnlyTitle: 'Read-only account directory',
    readOnlyDescription: 'Public groups are visible to every user. Group permission or an active subscription exposes the matching dedicated-group accounts, including accounts leased directly to you. This page never controls upstream accounts.',
    privacyNotice: 'Email-shaped account names are masked on the server. Credentials, proxies, IPs, models, and health errors are not exposed.',
    emptyTitle: 'No accounts to display',
    emptyDescription: 'There are no public-group accounts or accessible dedicated-group accounts to display.',
    noFilterResultsTitle: 'No matching accounts',
    noFilterResultsDescription: 'Adjust or clear the filters and try again.',
    account: 'Account',
    group: 'Group',
    source: 'Source',
    sourcePublic: 'Public group',
    sourceDedicated: 'Dedicated group',
    ...
    tokens: 'tokens',
    assignedAt: 'Assigned',
    coolingUntilLabel: 'Expected recovery',
    ...
    showing: 'Showing {count} of {total} accounts',
    resetFilters: 'Clear filters',
    tableAriaLabel: 'Read-only account directory',
    ...
    usageScopes: {
      rolling24h: 'This group, last 24 hours',
      personalLease: 'Your current assignment'
    },
    usageWindows: {
      rolling24h: '24h',
      personalLease: 'Lease'
    ...
    summary: {
      ...
      dedicatedGroups: 'Dedicated groups',
      visibleAccounts: 'Visible accounts',
      readyAccounts: 'Ready now'
    },
    status: {
      ready: 'Ready',
      cooling: 'Cooling',
