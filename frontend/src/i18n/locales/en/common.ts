export default {
  ...
  accountAllocations: {
    ...
    description: 'Review public-group accounts and the dedicated accounts assigned to you.',
    readOnlyTitle: 'Read-only account directory',
    readOnlyDescription: 'Public groups are visible to every user. Dedicated accounts appear only when you are assigned to them and retain current group access or an active subscription. This page never controls upstream accounts.',
    ...
    emptyDescription: 'There are no public-group accounts or dedicated assignments currently available for you to view.',
    ...
    sourceDedicated: 'Dedicated assignment',
