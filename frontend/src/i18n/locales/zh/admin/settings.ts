    ...
    settings: {
      ...
      features: {
        ...
        citySimulation: {
          ...
          pixelRenderer: '启用共享实时像素渲染',
          pixelRendererHint: '控制实时像素世界的投影、视觉资料、地图 Chunk 和增量读取接口。关闭后不会删除世界或时间线，仅停止该内容面的成员访问。',
          visualPackPublish: '允许发布视觉包',
      ...
      site: {
        ...
        tablePreferencesTitle: '表格与账号目录设置',
        tablePreferencesDescription: '设置后台与用户侧表格的分页行为，以及账号目录的自动刷新频率',
        ...
        accountDirectoryRefreshInterval: '账号目录自动刷新间隔（秒）',
        accountDirectoryRefreshIntervalHint: '设为 0 关闭自动刷新；启用时范围为 15-3600 秒。刷新只读取服务端缓存和统计，不会主动查询上游。',
        accountDirectoryRefreshIntervalRangeError: '自动刷新间隔必须为 0，或 {min}-{max} 之间的整数',
        customEndpoints: {
          title: '自定义端点',
