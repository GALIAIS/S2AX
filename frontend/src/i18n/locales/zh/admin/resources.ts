export default {
    accountAllocations: {
      ...
      noUsers: '没有可选择的启用用户',
      userHint: '策略不会修改用户已有 API Key 或分组授权。',
      ...
      replace401: '替换认证/不可用账号',
      replace401Hint: '账号进入持久化的认证失败、禁用、到期或不可调度状态时释放，并按目标数补齐。',
      replace429: '替换限流冷却账号',
      ...
      release: '释放分配',
      releaseConfirm: '释放后该账号会重新成为共享池候选；如果自动补齐已开启，系统可能立即分配其他空闲账号。',
      released: '分配已释放',
