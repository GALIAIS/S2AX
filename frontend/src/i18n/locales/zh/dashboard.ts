export default {
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      devin: {
        description: '通过当前 Devin 分组配置 Claude Code、Codex 或 OpenCode。',
        codexDescription: '使用 API Key 配置 Codex，并通过当前 Devin 分组发送请求。',
        codexConfigTomlHint: '下载下方模型目录，将两个文件保存到 Codex 配置目录后重启 Codex。',
        codexNote: '启动 Codex 前先导出 SUB2API_API_KEY。下载的目录只包含模型元数据，不包含 API Key。'
      },
      composite: {
  ...
  usage: {
    ...
    serviceTier: '服务档位',
    pricingBasis: '价格口径',
    pricingBasisFast: '按 Fast 单价',
    pricingBasisFlex: '按 Flex 单价',
    pricingBasisStandard: '按标准单价',
    groupMultiplier: '分组倍率',
    pricingChannel: '计费渠道',
    billingSubtotal: '计费小计',
    tokenCostFormula: '数量 × 单价',
