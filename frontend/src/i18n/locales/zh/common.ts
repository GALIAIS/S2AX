export default {
  ...
  accountAllocations: {
    title: '账号目录',
    description: '查看公开分组账号，以及分配给您的专属分组账号。',
    readOnlyTitle: '只读账号目录',
    readOnlyDescription: '公开分组对所有用户可见；专属账号仅在您具备当前分组权限或有效订阅且被分配后显示。此页面只能查看，不能操作上游账号。',
    privacyNotice: '邮箱形式的账号名称会在服务端脱敏；凭据、代理、IP、模型和健康错误不会显示。',
    emptyTitle: '暂无可查看账号',
    emptyDescription: '当前没有公开分组账号，也没有可供您查看的专属分配账号。',
