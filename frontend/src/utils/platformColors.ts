...
const BADGE: Record<Platform, string> = {
  ...
  devin: 'bg-violet-500/10 text-violet-600 border-violet-500/30 dark:text-violet-400',
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  devin: 'bg-violet-500/10 text-violet-600 dark:bg-violet-500/10 dark:text-violet-300',
...
const BORDER: Record<Platform, string> = {
  ...
  devin: 'border-violet-500/20 dark:border-violet-500/20',
...
const BORDER_STRONG: Record<Platform, string> = {
  ...
  devin: 'border-violet-500/35 dark:border-violet-500/30',
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  devin: 'bg-gradient-to-r from-violet-400 to-violet-500',
...
const TEXT: Record<Platform, string> = {
  ...
  devin: 'text-violet-600 dark:text-violet-400',
...
const ICON: Record<Platform, string> = {
  ...
  devin: 'text-violet-500 dark:text-violet-400',
...
const BUTTON: Record<Platform, string> = {
  ...
  devin: 'bg-violet-500 text-white hover:bg-violet-600 active:bg-violet-700 dark:bg-violet-500/80 dark:hover:bg-violet-500',
...
const DISCOUNT: Record<Platform, string> = {
  ...
  devin: 'bg-violet-100 text-violet-700 dark:bg-violet-900/40 dark:text-violet-300',
...
const GRADIENT: Record<Platform, string> = {
  ...
  devin: 'from-violet-500 to-violet-600',
