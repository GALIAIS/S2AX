...
const groupPricingFromAPI = (
  ...
  (pricing || []).map((entry) => ({
    ...
    input_price_priority: perTokenToMTok(entry.input_price_priority),
    output_price: perTokenToMTok(entry.output_price),
    output_price_priority: perTokenToMTok(entry.output_price_priority),
    cache_write_price: perTokenToMTok(entry.cache_write_price),
    cache_write_price_priority: perTokenToMTok(entry.cache_write_price_priority),
    cache_write_1h_price: perTokenToMTok(entry.cache_write_1h_price),
    cache_read_price: perTokenToMTok(entry.cache_read_price),
    cache_read_price_priority: perTokenToMTok(entry.cache_read_price_priority),
