...
describe('EditAccountModal', () => {
  ...
  // 回归验证 OpenAI setup-token 账号也能读取并保存指纹收敛模式。
  it('loads and submits Codex fingerprint convergence for OpenAI setup-token accounts', async () => {
    ...
    expect(select.element.value).toBe('session')
