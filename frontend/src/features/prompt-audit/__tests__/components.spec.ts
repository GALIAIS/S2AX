...
describe('Prompt Audit components', () => {
  ...
  it('supports group search, stale configured groups, nine scanners, and bounded worker inputs', async () => {
    const draft: PromptAuditDraft = {
      enabled: true, blocking_enabled: false, blocking_latest_turn_only: false, store_pass_events: false, failure_mode: 'block_and_record', effective_mode: 'async_audit', strategy: 'priority',
